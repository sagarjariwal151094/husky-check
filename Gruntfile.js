module.exports = function(grunt){
    ...
    var SOURCE_DIR = './', //root path of plugin folder
        ZIP_FILE_NAME = 'advanced-flat-rate-shipping-for-woocommerce.zip', //add name of final zip
        BKP_FILE_SGGESTION = "(backup|bkp)", //add multiple back up file slug here to remove from plugin before making zip
        TEXT_DOMAIN = ['advanced-flat-rate-shipping-for-woocommerce'], //list out textdomain for check in whole plguin files
        PLUGIN_MAIN_FILE = 'advanced-flat-rate-shipping-for-woocommerce.php', //write down main file name of plugin
        POT_FILE_NAME = 'advanced-flat-rate-shipping-for-woocommerce.pot', //write down POT file name
    ...
    grunt.initConfig({
        ...
        phpcs: {
            application: {
                expand: true,
                src: ['**/*.php', '!**/freemius/**', '!**/node_modules/**', '!**/vendor/**', '!**/*.min.js', '!**/Gruntfile.js', '!**/jquery.*.js', '!**/help-scout-beacon.js'],
            },
            options: {
